...
aws s3 cp s3://${ENVIRONMENT}-training-static-files.pathmind.com/nativerl/1_6_0/nativerl-1.6.0-SNAPSHOT-bin.zip nativerl-1.6.0-SNAPSHOT-bin.zip > /dev/null ;
...
mkdir -p work ;
cd work ;
unzip ../nativerl-1.6.0-SNAPSHOT-bin.zip > /dev/null ;
rm ../nativerl-1.6.0-SNAPSHOT-bin.zip ;
mv nativerl-bin/* . ;
