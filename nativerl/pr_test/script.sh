...
aws s3 cp s3://${ENVIRONMENT}-training-static-files.pathmind.com/nativerl/1_3_0_dh/nativerl-1.3.0.DH-SNAPSHOT-bin.zip nativerl-1.3.0.DH-SNAPSHOT-bin.zip > /dev/null ;
...
mkdir -p work ;
cd work ;
unzip ../nativerl-1.3.0-SNAPSHOT-bin.zip > /dev/null ;
rm ../nativerl-1.3.0-SNAPSHOT-bin.zip ;
mv nativerl-bin/* . ;
