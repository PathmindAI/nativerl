...
aws s3 cp s3://${ENVIRONMENT}-training-static-files.pathmind.com/nativerl/1_8_1/nativerl-1.8.1-SNAPSHOT-bin.zip nativerl-1.8.1-SNAPSHOT-bin.zip > /dev/null ;
...
mkdir -p work ;
cd work ;
unzip ../nativerl-1.8.1-SNAPSHOT-bin.zip > /dev/null ;
