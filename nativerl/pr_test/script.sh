...
aws s3 cp s3://${ENVIRONMENT}-training-static-files.pathmind.com/nativerl/1_7_2/nativerl-1.7.2-SNAPSHOT-bin.zip nativerl-1.7.2-SNAPSHOT-bin.zip > /dev/null ;
...
mkdir -p work ;
cd work ;
unzip ../nativerl-1.7.2-SNAPSHOT-bin.zip > /dev/null ;
rm ../nativerl-1.7.2-SNAPSHOT-bin.zip ;
mv nativerl-bin/* . ;
