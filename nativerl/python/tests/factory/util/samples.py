...
def get_default_factory(random_seed=None, num_tables=8, num_cores=3, num_phases=1,
    ...
    if scenario == "fixed_2":
        ...
        tables = create_scenario(table_nodes, target_nodes, rails, num_tables, num_cores, num_phases)
        ...
        table_nodes = [node_17_a, node_14_c, node_02, node_16_b, node_04_a, node_18, node_01_a, node_20]
        target_nodes = [node_00, node_06, node_06, node_04_a, node_00, node_04_a, node_04_a, node_06]
        tables = create_scenario(table_nodes, target_nodes, rails, num_tables, num_cores, num_phases)
    elif scenario == "fixed_10":
        table_nodes = [node_17_a, node_14_c, node_02, node_16_b, node_04_a, node_18, node_01_a, node_20, node_03_a, node_13]
        target_nodes = [node_00, node_06, node_06, node_04_a, node_00, node_04_a, node_04_a, node_06, node_14_a, node_14_a]
        tables = create_scenario(table_nodes, target_nodes, rails, num_tables, num_cores, num_phases)
    elif scenario == "fixed_12":
        table_nodes = [node_17_a, node_14_c, node_02, node_16_b, node_04_a, node_18, node_01_a, node_20, node_03_a, node_13, node_15_a, node_05]
        target_nodes = [node_00, node_06, node_06, node_04_a, node_00, node_04_a, node_04_a, node_06, node_14_a, node_14_a, node_00, node_14_a]
        tables = create_scenario(table_nodes, target_nodes, rails, num_tables, num_cores, num_phases)
    elif scenario == "random":
        tables = create_random_tables_and_cores(nodes, rails, num_tables, num_cores, num_phases)
    elif scenario == "random_fixed_targets":
        target_nodes = [node_00, node_06, node_06, node_04_a, node_00, node_04_a]
        tables = create_random_tables_fixed_target_nodes(nodes, target_nodes, rails, num_tables, num_cores, num_phases)
    else:
...
def create_scenario(table_nodes, target_nodes, rails, num_tables, num_cores, num_phases):
...
def create_random_tables_fixed_target_nodes(nodes, target_nodes, rails, num_tables, num_cores, num_phases):
    non_rail_nodes = [n for n in nodes if not n.is_rail]
    for rail in rails:
        # Add precisely one spot on each rail that a table could be placed on
        non_rail_nodes.append(random.choice(rail.nodes))
    ...
    for idx in range(num_cores):
        cycle = {}
        core_indices = np.random.choice(range(len(target_nodes)), num_phases, replace=False)
        for p in range(num_phases):
