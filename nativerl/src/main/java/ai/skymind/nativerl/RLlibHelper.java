    ...
    public String generatePythonTrainer() {
        ...
        String trainer = "import glob, gym, nativerl, ray, sys, os, random\n"
            ...
            + (multiAgent
                ...
                + "        self.converged = False # Slope flattened\n"
                ...
                + "\n"
                + "        # Configs\n"
                + "        self.reward_slope_threshold = 0.1 # Remove with 0\n"
                + "        self.entropy_slope_threshold = 0.01 # Remove with -9999999\n"
                + "        self.vf_loss_slope_threshold = 0.1 # Remove with 0\n"
                ...
                + "        self.step_check = 200000 # Remove with +9999999\n"
                + "\n"
                ...
                + "            # Convergence Trends\n"
                + "            if result['training_iteration'] > self.early_check:\n"
                + "                self.episode_reward_window.append(result['info/learner/default_policy/reward'])\n"
                + "\n"
                + "            # Convergence Filter\n"
                + "            if result['training_iteration'] >= self.converge_check:\n"
                + "                self.episode_reward_slope = self.episode_reward_window[-1] - self.episode_reward_window[-50]\n"
                + "                self.episode_reward_slope_later =  self.episode_reward_window[-1] - self.episode_reward_window[-25]\n"
