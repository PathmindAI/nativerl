    ...
    public String generatePythonTrainer() {
        ...
        String trainer = "import glob, gym, nativerl, ray, sys, os, random\n"
            ...
            + (multiAgent
                ...
                + "            self.value_pred_great = np.mean(np.array(self.vf_pred_adequate_window[-5:])) > self.value_pred_great_threshold\n"
                ...
                + "            self.value_pred_adequate = np.mean(np.array(self.vf_pred_adequate_window[-5:])) > self.value_pred_adequate_threshold\n"
                + "\n"
