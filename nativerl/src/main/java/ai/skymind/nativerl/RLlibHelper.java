    ...
    public String generatePythonTrainer() {
        ...
        String trainer = "import glob, gym, nativerl, ray, sys, os, random\n"
            ...
            + (multiAgent
                ...
                + "        self.value_pred_adequate_threshold = 0.9 # Remove with 1\n"
                + "\n"
                ...
                + "            if not self.should_stop and self.episode_reward_converged and (self.value_pred_converged or self.value_pred_adequate):\n"
                + "                self.should_stop = True\n"
                + "                return self.should_stop\n"
                + "\n"
