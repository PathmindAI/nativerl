...
------------------
 ...
 3. Find all output files inside the `nativerl/target/nativerl-1.6.2-SNAPSHOT-bin.zip` archive
    * This also produces `nativerl-policy/target/nativerl-policy-1.6.2-SNAPSHOT.jar` (~231mb) for the PathmindHelper
...
unzip -j nativerl-1.6.2-SNAPSHOT-bin.zip
```
...
---------------------------------------------------------------
 ...
 3. Extract the native libraries from `nativerl-1.6.2-SNAPSHOT-bin.zip` inside that directory
...
------------------------------------------
 ...
 1. Extract the native libraries from `nativerl-1.6.2-SNAPSHOT-bin.zip` somewhere
