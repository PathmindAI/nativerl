...
def buildNativerl(image_name) {
    ...
    sh "aws s3 cp ${WORKSPACE}/nativerl/target/nativerl-1.2.0-SNAPSHOT-bin.zip s3://test-training-static-files.pathmind.com/nativerl/${tag}/nativerl-1.2.0-SNAPSHOT-bin.zip"
    sh "aws s3 cp ${WORKSPACE}/nativerl/target/nativerl-1.2.0-SNAPSHOT-bin.zip s3://dev-training-static-files.pathmind.com/nativerl/${tag}/nativerl-1.2.0-SNAPSHOT-bin.zip"
    sh "aws s3 cp ${WORKSPACE}/nativerl/target/nativerl-1.2.0-SNAPSHOT-bin.zip s3://prod-training-static-files.pathmind.com/nativerl/${tag}/nativerl-1.2.0-SNAPSHOT-bin.zip"
}
